...
#API key connection
def Api_connect():
    Api_Id="AIzaSyCs9lpR-pE0vPyGEomdqI7CIaQssj_tHJc"
...
client = pymongo.MongoClient("mongodb+srv://mkalpana683:mkaviya@kaviya.l0acn.mongodb.net/?retryWrites=true&w=majority&appName=Kaviya")
db = client["Y_data"]
...
def playlists_table():
    ...
    create_query1 = '''CREATE TABLE IF NOT EXISTS playlists (
    ...
    for pl_data in coll1.find({}, {"_id": 0, "playlist_inforamtion": 1}):
        for i in range(len(pl_data['playlist_inforamtion'])):
            pl_list.append(pl_data['playlist_inforamtion'][i])
